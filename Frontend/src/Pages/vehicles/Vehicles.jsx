      ...
      const updatedFilteredVehicles = vehiclesData
        ...
        .filter(
          (vehicle) =>
            ...
            (vehicle?.REGNO &&
              vehicle?.REGNO.toLowerCase().includes(
                searchVehicle.toLowerCase()
              ))
        );
                  ...
                  <ul className="dropdown-menu">
                    ...
                    <li>
                      <a
                        className="dropdown-item"
                        onClick={() =>
                          setVehicleType("SEATER CUM SLEEPER NON AC")
                        }
                      >
                ...
                <tbody>
                  ...
                  {displayedVehicles.map((vehicle) => (
                    <tr key={vehicle.id}>
                        ...
                        <div className="btn-group">
                          ...
                          <ul className="dropdown-menu">
                            ...
                            <li
                              ...
                              role="button"
                              onClick={() =>
                                handleChangeVehicleStatus(vehicle, "in_service")
                              }
                            >
                              In Service
                            </li>
                            <li
                              ...
                              role="button"
                              onClick={() =>
                                handleChangeVehicleStatus(vehicle, "dock")
                              }
                            >
                              ock
                            </li>
                      ...
                      <td>
                        {vehicle.dock_reason} {vehicle.dock_depot}
                      </td>
                      <td>
