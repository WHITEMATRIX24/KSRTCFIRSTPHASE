...
import { deleteSingleVehicleAPI, editStatus, getAllVehicles, updateVehicleStatus } from "../../services/allAPI";
                    ...
                    <div className="container-fluid">
                        ...
                        <div className="d-flex justify-content-between align-items-center mt-3">
                            ...
                            <div className="d-flex gap-4 align-items-center me-5">
                                ...
                                <div className="btn-group">
                                    <button type="button" className="btn btn-light dropdown-toggle rounded px-4" data-bs-toggle="dropdown" aria-expanded="false" >
                                        {itemsPerPage}
                                    </button>
                                    <ul className="dropdown-menu">
                                        {[10, 20, 30].map(size => (
                                                    ...
                                                    <Modal size="lg" centered show={show} onHide={handleClose} backdrop="static" keyboard={false} >
                                                        ...
                                                        <Modal.Body>
                                                            <Form>
                                                                ...
                                                                <Form.Control type="text" name="dockDepot"
                                                                    placeholder='Enter the Depot'
                                                                    value={dockDetails.dock_depot}
                                                                    onChange={(e) => setDockDetails({ ...dockDetails, dock_depot: e.target.value })}
                                                                />
                                                                <Form.Label className="mb-1" style={{ fontSize: "14px" }}>Description </Form.Label>
                                                                <Form.Control as="textarea" name="description" placeholder='Enter the Description' rows={4} value={dockDetails.dock_reason}
